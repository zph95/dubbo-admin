...
<template>
  <v-container grid-list-xl fluid >
    <v-layout row wrap>
      <v-flex lg12>
        <breadcrumb title="serviceRelationV2" :items="breads"></breadcrumb>
      </v-flex>
    </v-layout>

    <v-flex lg12>
      <v-card>
        <div id="chartContent" style="width:100%;height:800%;" />
      </v-card>
    </v-flex>
...
export default {
  ...
  methods: {
    initData: function () {
      ...
      this.$axios.get('/metrics/relationV2')
        .then(response => {
